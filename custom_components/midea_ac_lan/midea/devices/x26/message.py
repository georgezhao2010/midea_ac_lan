...
class MessageSet(Message26Base):
    def __init__(self, device_protocol_version):
        ...
        self.bath_mode = False
        self.ventilation_mode = False
        self.drying_mode = False
        self.blowing_mode = False
        self.gentle_wind_mode = False
    ...
    def _body(self):
        return bytearray([
            ...
            1 if self.gentle_wind_mode else 0,
